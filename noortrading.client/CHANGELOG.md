...
- Créez un projet React avec create-vite : `npm init --yes vite@latest noortrading.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Créez le fichier projet (`noortrading.client.esproj`).
